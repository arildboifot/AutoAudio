...
namespace AutoAudio.Impl
{
    public class SoundConfig
    {
        ...
        /// <returns></returns>
        internal static IEnumerable<OutputItem> ParseEndpointOutput(string output)
        {
        ...
        public static OutputItem GetDefaultDevice()
        {
            return ListDevices().FirstOrDefault(x => x.IsDefault);
        }
    }
}
